...
import (
	...
	"github.com/kildevaeld/projects/Godeps/_workspace/src/golang.org/x/crypto/ssh/terminal"
...
var (
	flagNextProto = flag.String("nextproto", // Flags
	"h2,h2-14", "Comma-separated list of NPN/ALPN protocol names to negotiate.")
